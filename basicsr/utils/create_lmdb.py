...
def create_lmdb_for_SIDD():
    ...
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
    '''
def create_lmdb_for_mcfs():

    # To make your own .lmdb datasets: you should change the path to your own path
    folder_path = r"D:\PhDprojects\MCFsImaging\SGARNet\datasets\MCFsDataset\train\input_all"
    lmdb_path = r"D:\PhDprojects\MCFsImaging\SGARNet\datasets\MCFsDataset\train\input_all.lmdb"

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    folder_path = r"D:\PhDprojects\MCFsImaging\SGARNet\datasets\MCFsDataset\train\target_all"
    lmdb_path = r"D:\PhDprojects\MCFsImaging\SGARNet\datasets\MCFsDataset\train\target_all.lmdb"

    img_path_list, keys = prepare_keys(folder_path, 'png')
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, map_size=10 * 1024 * 1024 * 1024)
